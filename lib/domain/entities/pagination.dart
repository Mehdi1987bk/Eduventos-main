...
class _Converter<T> implements JsonConverter<T, Object> {
  ...
  T fromJson(Object json) {
    if (T == GetPostsResponse) {
      return GetPostsResponse.fromJson(json as Map<String, dynamic>) as T;
    }
    if (T == Exam) {
      return Exam.fromJson(json as Map<String, dynamic>) as T;
    }

    if (T == GetNotifications) {
      return GetNotifications.fromJson(json as Map<String, dynamic>) as T;
    }

    if (T == SubjectResult) {
      return SubjectResult.fromJson(json as Map<String, dynamic>) as T;
    }
